...
ARGS_ENV="--env GLIDEIN_RANDOMIZE_NAME=true,OSG_PROJECT_NAME=IceCube,CPUS=$CPUS,NUM_CPUS=$NUM_CPUS,MEMORY=$MEMORY,DISK=$DISK,ACCEPT_IDLE_MINUTES=$ACCEPT_IDLE_MINUTES,ACCEPT_JOBS_FOR_HOURS=$ACCEPT_JOBS_FOR_HOURS"
